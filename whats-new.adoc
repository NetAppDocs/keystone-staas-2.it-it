...
=== Oltre la capacità di burst nel grafico storico dei consumi
...
Tre nuove colonne, *Dati attivi*, *Livello freddo (%)* e *Livello attivo (%)*, sono state aggiunte alla scheda *Volumi nei cluster* in *Risorse*. Per saperne di più, fare riferimento a link:./integrations/assets-tab.html["Visualizza le risorse associate a un abbonamento Keystone"] e link:./integrations/assets.html["Visualizza le risorse nei tuoi abbonamenti Keystone"].
...
Puoi contattare il team di supporto Keystone per abbonarti alla versione 3 (v3) Keystone . Per maggiori dettagli, fare riferimento a link:https://docs.netapp.com/us-en/keystone-staas/concepts/support-services.html["Ottieni assistenza con Keystone"].

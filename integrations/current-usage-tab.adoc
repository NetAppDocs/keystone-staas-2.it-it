...
+
image:console-current-consumption-table.png["dettagli del consumo attuale nel formato tabella"]

+

NOTE: Se hai sottoscritto un abbonamento a servizi aggiuntivi come advanced data protection (ADP) o Data Infrastructure Insights (DII), il consumo attuale di questi servizi viene visualizzato insieme ai livelli di servizio delle prestazioni di base, sia in forma grafica che tabellare. Per ulteriori informazioni sui servizi aggiuntivi, consulta link:../concepts/adp.html["Scopri di più sui servizi aggiuntivi"].

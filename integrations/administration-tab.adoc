...
.Passi
. Dal menu di navigazione a sinistra della Console, selezionare *Archiviazione > Keystone > Amministrazione*.
+
...
+
image:console-service-request-list.png["uno screenshot mostra per quali livelli di servizio prestazionali vengono sollevate le richieste di modifica"]

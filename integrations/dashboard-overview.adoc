...
* *Monitor subscription details*: visualizza informazioni dettagliate sui tuoi abbonamenti Keystone, inclusi i livelli di servizio delle prestazioni (servizi di base e aggiuntivi come protezione avanzata dei dati e Data Infrastructure Insights), utilizzo della capacità, risorse e avvisi.

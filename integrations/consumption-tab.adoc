...
Il consumo visualizzato di 94,21 TiB rappresenta l'utilizzo per l'abbonamento principale.  Poiché la protezione avanzata dei dati suddivide il consumo tra i siti partner con abbonamenti separati, questo grafico mostra solo l'utilizzo del sito principale.  Per informazioni sui prezzi del servizio aggiuntivo di protezione dati avanzata, fare riferimento alink:../concepts/adp.html#understand-pricing["Capire i prezzi"] .

...
image:console-overview.png["uno screenshot della scheda Panoramica"]
...
* *Avvisi non risolti per gravità*: elenca il totale degli avvisi non risolti in base alla gravità: Critico, Avviso e Informativo. Ogni categoria include un pulsante *Visualizza* per rivedere i dettagli e intraprendere ulteriori azioni.
...
* *Avvisi Keystone non risolti più vecchi*: visualizza una tabella degli avvisi critici non risolti più vecchi tra gli abbonamenti.

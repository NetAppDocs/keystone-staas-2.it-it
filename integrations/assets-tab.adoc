...
* Le opzioni del menu a discesa *Visualizza* dipendono dalle piattaforme di abbonamento Keystone . *Volumi in cluster* e *Nodi in cluster* sono disponibili per ONTAP. Per StorageGRID, il menu a discesa *Visualizza* non è disponibile, la tabella *Nodi nelle griglie* viene visualizzata automaticamente. Se il tuo abbonamento include entrambe le piattaforme, saranno disponibili tutte e tre le opzioni.
...
+
Vengono visualizzate informazioni dettagliate sui volumi nei cluster, tra cui nome del volume, numero di serie del nodo, conformità con le policy QoS, nome del cluster, host name e livelli di servizio delle prestazioni. È inoltre possibile monitorare la capacità fornita, l'utilizzo logico e fisico, i dati cold e i dati hot.

+

NOTE: Le colonne *Cold tier %* e *Hot tier %* mostrano la percentuale di dati su ciascun tier, calcolata come (Cold data / Total footprint) × 100 e (Hot data / Total footprint) × 100 rispettivamente.

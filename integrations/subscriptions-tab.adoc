...
+
image:bxp-subscription-list-2.png["visualizza i dettagli della scheda abbonamento"]

+
Vengono visualizzate le metriche chiave, quali l'utilizzo della capacità, lo stato di scadenza dell'abbonamento e gli avvisi non risolti. Nella tabella è possibile visualizzare i seguenti dettagli:

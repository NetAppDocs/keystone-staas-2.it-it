...
NOTE: Solo i pacchetti di terze parti elencati sopra sono supportati su Keystone Collector. L'installazione di software aggiuntivo non è supportata e può influire sulle prestazioni del collector, sulla raccolta di dati e sulla precisione della fatturazione.
...
* Ogni mese, esporta un file da Keystone Collector e invialo via e-mail al team di supporto NetApp . Per maggiori informazioni su come contattare il team di supporto, fare riferimento a link:../concepts/support-services.html["Ottieni assistenza con Keystone"].
